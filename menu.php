		...
		<div class="row g-0" >	<!-- Wrapper -->
			...
			<nav class="col-2 bg-dark pr-3 border-right"> <!-- Left Side Nav -->
				...
				<div class="list-group text-center bg-dark text-lg-left" >
					...
					<div id="box">
					<a href="menu.php" class="list-group-item list-group-item-action active">
			...
			<main class="col-10 bg-dark"> <!-- Main (Top Nav & Content) -->
				...
				<div class="container-fluid  "> <!-- Content -->
					...
					<div><h2 class="h6 text-white-50">ADD MENUS</h2></div>
					<div class="row mb-3">	<!-- Content Row 0 -->
						<div class="col">
							<div class="alert alert-info bg-light" >
								<iframe src="menulist.php" frameborder="0"width="990px" height="550px" name="ouriframe" style="float:top" class="col-12"></iframe>
							</div>
						</div>
					</div>
