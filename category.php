		...
		<div class="row g-0" >	<!-- Wrapper -->
			...
			<main class="col-10 bg-dark"> <!-- Main (Top Nav & Content) -->
				...
				<div class="container-fluid  "> <!-- Content -->
					...
					<div><h2 class="h6 text-white-50">ADD CATEGORY</h2></div>
						<?php
           ...
           <?php
            ...
            <div class="col-md-6 " >
				...
				while($row=mysqli_fetch_array($go_query))
				{
					...
					echo "<td>{$cat_id}</td>";
					echo "<td>{$cat_name}</td>";
					echo "<td><a href='category.php?action=delete&c_id={$cat_id}'class='fa fa-trash'></a>|| 
		<a href='category.php?action=edit&c_id={$cat_id}' class='fa fa-edit'></a>
					</td>";
					echo "</tr>";
				}
				?>
